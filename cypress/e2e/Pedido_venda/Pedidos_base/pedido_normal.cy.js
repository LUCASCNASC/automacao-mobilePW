...
import { clicarBotaoTresPontos, clicarExpandirClienteProcesso, processoVendaPrincipal, clicarInformeCliente, escolherClientePedido, 
         ...
         tirarEntregaSegundo, escolherRota, escolherTransportadora, avancarParaTransportadora, avancarParcelasEntrega, modalInconsRotaTransp} from '../../../support/para_pedidos/para_pedidos.js';
...
describe('Gerar pedido normal', () => {
    ...
    context('Com frete/ processo 9860 - caminho feliz', () => {
        ...
        it.skip('Pedido de venda: produto 1860 0 0 - (Venda local de produto com saldo - com entrega)', () => {
